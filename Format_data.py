...
class d2j():
    ...
    def get_color(self,item):
        ...
        # flouser = list(self.collection2.find({'followuser': self.uid}).sort("deepth", 1))
        # fanuser = list(self.collection2.find({'userid': self.uid}).sort("deepth", 1))
        # for colori in flouser:
        #     vari = colori['deepth']
        #     if vari == 1:
        #         linecolor = '#FF6A6A'
        #     elif vari == 2:
